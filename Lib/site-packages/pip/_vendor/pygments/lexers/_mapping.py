...
LEXERS = {
    ...
    'BddLexer': ('pip._vendor.pygments.lexers.bdd', 'Bdd', ('bdd',), ('*.features',), ('text/x-bdd',)),
    ...
    'GherkinLexer': ('pip._vendor.pygments.lexers.testing', 'Gherkin', ('gherkin', 'cucumber'), ('*.features',), ('text/x-gherkin',)),
