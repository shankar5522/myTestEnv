...
def deprecated(
    *,
    ...
    gone_in:
        ...
        this.
    feature_flag:
        Command-line flag of the form --use-features={feature_flag} for testing
    ...
    # Determine whether or not the features is already gone in this version.
    ...
    message_parts = [
        ...
        (
            feature_flag,
            "You can use the flag --use-features={} to test the upcoming behaviour."
            if not is_gone
            else None,
        ),
        (
