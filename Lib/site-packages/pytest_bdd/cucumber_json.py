...
class LogBDDCucumberJSON:
    ...
    def pytest_runtest_logreport(self, report: TestReport) -> None:
        ...
        if scenario["features"]["filename"] not in self.features:
            self.features[scenario["features"]["filename"]] = {
                "keyword": "Feature",
                "uri": scenario["features"]["rel_filename"],
                "name": scenario["features"]["name"] or scenario["features"]["rel_filename"],
                "id": scenario["features"]["rel_filename"].lower().replace(" ", "-"),
                "line": scenario["features"]["line_number"],
                "description": scenario["features"]["description"],
                "tags": self._serialize_tags(scenario["features"]),
                "elements": [],
            }

        self.features[scenario["features"]["filename"]]["elements"].append(
            {
                "keyword": "Scenario",
                "id": report.item["name"],
                "name": scenario["name"],
