...
test_publish_article = scenario(
    feature_name="publish_article.features",
    ...
    try:
        ...
        try:
            ...
            raise exceptions.StepDefinitionNotFoundError(
                ...
                f'Line {step.line_number} in scenario "{scenario.name}" in the features "{scenario.feature.filename}"'
            ) from e2
...
def scenario(
    ...
    :param str feature_name: Feature file name. Absolute or relative to the configured features base path.
    ...
    try:
        ...
        raise exceptions.ScenarioNotFound(
            f'Scenario "{scenario_name}" in features "{feature_name}" in {feature.filename} is not found.'
        )
...
def scenarios(*feature_paths: str, **kwargs: Any) -> None:
    ...
    :param *feature_paths: features file paths to use for scenarios
    """
